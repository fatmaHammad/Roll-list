...
/* harmony import */ var _roll__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./roll */ "./src/app/roll.ts");
...
var AppComponent = /** @class */ (function () {
    function AppComponent() {
        this.title = 'Roll';
        this.rolls = [];
        this.newRoll = new _roll__WEBPACK_IMPORTED_MODULE_2__["Roll"]();
        this.lastId = 0;
    }
    ...
    AppComponent.prototype.delete = function (id) {
        //console.log(id)
        this.rolls = this.rolls.filter(function (roll) { return roll.id != id; });
    };
    AppComponent.prototype.toggleDone = function (roll) {
        for (var _i = 0, _a = this.rolls; _i < _a.length; _i++) {
            var i = _a[_i];
            if (i.id == roll.id) {
...
module.exports = __webpack_require__(/*! C:\Users\ooii\Desktop\traning\ToDO -H.W\src\main.ts */"./src/main.ts");
